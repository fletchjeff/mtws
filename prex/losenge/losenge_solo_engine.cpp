...
// Clamps output sample to signed 12-bit board range.
...
// Converts cutoff Hz to stable SVF coefficient in Q15.
...
// Maps controls to carrier settings, damping, and four filter center frequencies.
void LosengeSoloEngine::BuildRenderFrame(const solo_common::ControlFrame& control, RenderFrame& out) const {
  ...
  out.alt = control.alt;
  // Lower X increases damping, giving tighter resonant peaks.
...
// Renders one sample: excite four BPs from carrier and average pairs to stereo.
