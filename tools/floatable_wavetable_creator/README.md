...
- `/Users/jeff/Toonbox/MTWS/mtws/tools/floatable_wavetable_creator/AKWF`
...
```sh
cd /Users/jeff/Toonbox/MTWS/mtws/tools/floatable_wavetable_creator
python3 generate_akwf_manifest.py
```

This writes:

- `/Users/jeff/Toonbox/MTWS/mtws/tools/floatable_wavetable_creator/akwf_manifest.json`
