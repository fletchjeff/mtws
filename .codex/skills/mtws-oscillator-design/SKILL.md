...
description: Use when designing or reviewing a new oscillator for mtws, including sonic intent, control map, Utility-Pair helper reuse, realtime safety, docs, and validation before implementation.
---
...
3. Identify which helper or pattern from `../Utility-Pair/src/` or an existing `mtws` engine should be reused first.
